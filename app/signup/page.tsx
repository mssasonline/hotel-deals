        ...
        <main className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
          <div className="w-full max-w-md">
            <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden p-10 text-center">
              ...
              <Link
                href="/login"
                className="inline-block bg-brand-blue hover:bg-brand-blue-dark text-white font-bold px-6 py-3 rounded-xl transition-colors text-sm"
              >
                Back to Sign In
              </Link>
            </div>
            ...
            <div className="px-8 py-7 space-y-5">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-brand-gold hover:bg-yellow-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-xl text-base transition-all duration-200 shadow-sm shadow-brand-gold/30 active:scale-[0.99]"
                >
                  {submitting ? (
