        ...
        <div className="shrink-0 border-t border-gray-100 px-6 py-4 bg-gray-50">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleAdd}
              disabled={saving}
              className="px-4 py-2.5 text-sm font-semibold text-white bg-brand-blue hover:bg-brand-blue-dark rounded-xl transition-colors shadow-sm disabled:opacity-60 flex items-center gap-2 whitespace-nowrap"
            >
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 bg-brand-blue hover:bg-brand-blue-dark text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors shadow-sm whitespace-nowrap"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
