...
export default function SearchBar({
  ...
  return (
    <div className="sticky top-16 z-40 bg-brand-blue shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="bg-white rounded-xl flex flex-col sm:flex-row shadow-sm border border-gray-100">
          ...
          <button
            ...
            className="bg-brand-blue hover:bg-brand-blue-dark text-white font-semibold px-7 py-2.5 transition-colors text-sm whitespace-nowrap flex items-center justify-center gap-2 sm:rounded-r-xl"
          >
