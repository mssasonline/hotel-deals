-- ============================================================
-- Migration 051: Fix get_dashboard_stats — two bugs from 047:
--   1. total_users used role = 'guest' instead of role = 'user'
--   2. growth_pct was hardcoded to 0.00 instead of being calculated
-- Date: 2026-06-15
-- ============================================================
