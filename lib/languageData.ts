...
export const LANGUAGES: LanguageInfo[] = [
  ...
  { code: 'de',    nativeName: 'Deutsch',          englishName: 'German',               supported: true },
  ...
  { code: 'zh-cn', nativeName: '简体中文',          englishName: 'Chinese (Simplified)', supported: true },
  { code: 'zh-tw', nativeName: '繁體中文',          englishName: 'Chinese (Traditional)' },
  { code: 'pl',    nativeName: 'Polski',           englishName: 'Polish' },
  { code: 'el',    nativeName: 'Ελληνικά',         englishName: 'Greek' },
  { code: 'tr',    nativeName: 'Türkçe',           englishName: 'Turkish',              supported: true },
